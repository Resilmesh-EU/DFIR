...
**OUTPUT REQUIREMENT**:
- You MUST output your complete analysis as a valid JSON object and save it to the file: `dfir_reports/dfir_analysis.json`
- The JSON structure must include: executive_summary, incident_info, timeline, entry_points, compromised_systems, attack_objectives, iocs, mitre_techniques, security_recommendations, forensic_conclusions, technical_details
